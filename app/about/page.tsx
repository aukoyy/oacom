      ...
      <main className="">
        ...
        <div className="flex flex-col mt-12 lg:flex-row-reverse">
          ...
          <div className="w-full space-y-6 lg:w-1/2">
            <p>Hi! I'm Øyvind</p>
            <p>
              I'm an AWS Cloud and Platform Engineer with a passion for building
              tools and infrastructure that help others move faster.
            </p>
            <p>
              I design and develop secure, scalable internal platforms on AWS
              that make cloud development simpler, safer, and more enjoyable for
              engineering teams.
            </p>
            ...
            <section className="mt-12 space-y-8">
              ...
              <div>
                ...
                <p>
                  Fremtind Forsikring AS <br />
                  <span className="text-gray-500">Aug 2024 - now</span>
                </p>
              </div>
              <div>
                <h2 className="my-2 text-2xl font-light text-slate-700">
                  Certifications
                </h2>
              ...
              <Link
                href="/about/øyvind-aukner-cv.pdf"
                target="_blank"
