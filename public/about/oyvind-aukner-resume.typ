...
Cloud / Platform Engineer (AWS) · Sydney, NSW · Eligible for employer-sponsored visa (482 / 186)
...
- *AWS:* CloudFormation CDK, S3, EC2, ECS, EKS, Lambda, CloudFront, Transfer Family (SFTP), IAM, VPC, CloudWatch
